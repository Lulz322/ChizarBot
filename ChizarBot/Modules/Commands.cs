...
namespace Chizar_Bot.Modules
{
    public class Commands : ModuleBase<SocketCommandContext>
    {
        ...
        {
            List<ulong> Admins;
            Admins = ReadWriter.TakeUintList("AdminList");
            ...
            File.AppendAllText("BanList", id + "|" + context.Client.GetUser(DiscId).Username + "|" + dataTime + "\n");
        ...
        public async Task VipisatBan(string id, string length, string comment)
        {
            ...
            File.AppendAllText("BanList", id + "|" + context.Client.GetUser(DiscId).Username + "|" + dataTime + comment + "\n");
        ...
        public async Task VipisatBan(string id, string length, string comment, string kickReason)
        {
            ...
            File.AppendAllText("BanList", id + "|" + context.Client.GetUser(DiscId).Username + "|" + dataTime + "|" + comment + "|" + kickReason + "\n");
        ...
        public async Task PrintBanList()
        {
            ...
            Bans = ReadWriter.TakeStringList("BanList");
        ...
        public async Task UnBan(string uid)
        {
            ...
            await ReadWriter.RemoveObj(Convert.ToUInt64(uid), "BanList");
        }
